...
Customer Churn Prediction is a machine learning project that predicts whether a customer is likely to leave a company based on their demographic information, service details, and billing information.
# Dataset
The project uses a simulated customer churn dataset containing 200 customer records.
